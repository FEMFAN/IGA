% Input.m for 2D plate with hole
close all;
%clear all;
clc;
...
patch1.KP = [   -1   0
    ...
    -4  4
    0   4];
patch1.w8 = [1;(1+1/sqrt(2))/2;(1+1/sqrt(2))/2;1;
    1;1;1;1;
    1;1;1;1];
patch1.ndm = size(patch1.KP,2);
patch1.tdm = patch1.ndm;
patch1.XI = [0 0 0 .5 1 1 1];
...
patch2.KP = [   0   1
    ...
    4   4
    4   0];
patch2.w8 = [1;(1+1/sqrt(2))/2;(1+1/sqrt(2))/2;1;
    1;1;1;1;
    1;1;1;1];
patch2.ndm = size(patch2.KP,2);
patch2.tdm = patch2.ndm;
patch2.XI = [0 0 0 .5 1 1 1];
...
%load the patches into the patch structure
patches(1,:) = patch1;
patches(2,:) = patch2;
