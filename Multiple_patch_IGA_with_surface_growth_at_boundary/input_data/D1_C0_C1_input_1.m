% Input.m for 1D truss structure
close all;
%clear all;
clc;
...
%initialize structure for patch information
...
%load the patches into the patches structure
patches(1,:) = patch1;
patches(2,:) = patch2;