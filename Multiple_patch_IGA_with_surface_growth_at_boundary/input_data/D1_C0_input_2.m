function [fid,u_pre,f_pre,f_b,ttime,dt,loadcurve] = D1_C0_C1_input_2(n,m,p,k)
...
if load_flag ==1 %tension
    ...
    if drive_flag ==1
        ...
        elseif k == 2
           ...
           u_pre =  [ 2,0,2,1,0; %zero displacement in y-direction, ''makes the problem 1-D''
                      3,0,2,1,0;
                      4,0,2,1,0;
                      5,0,2,1,0;
                      2,0,1,1,0; %arbitrary displacements in x-direction for every control point except the slave displacements
                      3,0,1,1,0.01;
                      4,0,1,1,0.008;
                      5,0,1,1,-0.006];
